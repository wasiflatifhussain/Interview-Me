...
import "./CoverCards.css";
import { FaUserTie } from 'react-icons/fa';
import { DoughnutGraph } from './DoughnutGraph';


export default function CoverCards(props) {
  return (
    <div class="mainCard" style={{display: "flex"}}>
        ...
        <div style={{width: "18%", marginLeft:"-25px"}}>
            <div style={{paddingBottom: "15px"}}>Review Report for Cover Letter:</div>
        ...
        <div style={{width: "30%"}}>
            ...
            <div style={{textAlign: "right", marginRight: "10px"}}><input type="submit" className="deleteReq" value="Delete Letter" /></div>
